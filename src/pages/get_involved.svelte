...
<p> We welcome students of all backgrounds and disciplines to come create with us. Whether you've worked with data before 
    or not, anyone is welcome to contribute and publish with us. </p>
    <p>To get started, join us on Slack and fill out our <a href="https://forms.gle/CoddNychjDzz2x1v7" target="_blank">spring interest form</a> and we'll be in touch shortly.
    If you have any questions, feel free to shoot us an <a href="mailto:cornelldatajournal@gmail.com">email</a>.
    </p>
<h2>Events</h2>
